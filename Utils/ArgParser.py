    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description="DeepRLight\n" \
                                                 ...
                                                 "\tPavel Rastopchin, pavelr[at]gmail.com\n", \
                                                    epilog="")
    parser.add_argument("-n", "--network", type=str, default="Derech_akko_small", dest='network')
    parser.add_argument("-gm", "--gui-mode", type=bool, default=True, dest='gui')
    parser.add_argument("-e", "--episodes", type=int, default=1, dest='episodes',
                        help='Number of episodes for simulation, default: agent\'s default value')
    parser.add_argument("-s", "--steps", type=int, default=120, dest='max_steps',
